...
WORD: 0xea007ffe, 0xea007ffa, 0xea007ff6, 0xea007ff2, 0xea007fee, 0xea007fea, 0xea007fe6, 0xea007fe2
...
MOVW a1, 0xffff
MOVT a1, 0xffff
STR a1, v2, 0x1c  // 0x3f00 b21c <- 0xffff ffff
STR a1, v2, 0x20  // 0x3f00 b220 <- 0xffff ffff

MOVW a1, 0x0
MOVT a1, 0x200
STR a1, v2, 0x14  // 0x3f00 b214 <- 0x0200 0000
...
LDR a1, a3, 0x4   // a1 <- 0x3f20 0004
MOVW a4, 0x4000
MOVT a4, 0x2
ORRRS a1, a1, a4  // a1 | 0x0002 4000
STR a1, a3, 0x4   // 0x3f20 0004 <- a1

LDR a1, a3, 0x94  // a1 <- 0x3f20 0094
MOVW a4, 0xffff
MOVT a4, 0xfffc
ANDRS a1, a1, a4  // a1 & 0xfffc ffff
STR a1, a3, 0x94  // 0x3f20 0094 <- 1a
...
LDR a1, a3, 0x98  // a1 <- 0x3f20 0098
MOVW a4, 0x3fff
MOVT a4, 0xffff
ANDRS a1, a1, a4  // a1 & 0xffff 3fff
STR a1, a3, 0x98  // 0x3f20 0098 <- 1a
...
MOVW a1, 0x0
STR a1, a3, 0x94  // 0x3f20 0094 <- 0x0
...
MOVW a1, 0x0
STR a1, v3, 0x0  // 0x3f20 1000 <- 0x0

//10
// 11

MOVW a1, 0x7ff
STR a1, v3, 0x44  // 0x3f20 1044 <- 0x7ff
...
MOVW a1, 0x60
STR a1, v3, 0x2c  // 0x3f20 102c <- 0x60

MOVW a1, 0x301
STR a1, v3, 0x30  // 0x3f20 1030 <- 0x301

MOVW a1, 0x0
STR a1, v3, 0x34  // 0x3f20 1034 <- 0x0

MOVW a1, 0x10
STR a1, v3, 0x38  // 0x3f20 1038 <- 0x10
